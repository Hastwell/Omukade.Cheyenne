...
{
    public class RainerKnownTypesBinder : ISerializationBinder
    {
        public static readonly RainerKnownTypesBinder INSTANCE;

        static Dictionary<string, Type> RECOGNIZED_TYPES;
        static RainerKnownTypesBinder()
        {
            ...
            INSTANCE = new RainerKnownTypesBinder();
        }
